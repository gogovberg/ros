  ...
  try
    {
     ...
     /* 
      ...
      ROS_INFO("Objects cloud after filtering: %d data points.",objectpointsPtr->height * objectpointsPtr->width);
    */
      // publish filtered ground plane
...
int main (int argc, char** argv) {
  ...
  ros::Subscriber sub = nh.subscribe ("input", 1, callbackCylinder);
